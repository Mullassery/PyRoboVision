...
[private vulnerability reporting](https://github.com/Mullassery/PyRoboVision/security/advisories/new)
rather than opening a public issue. We aim to acknowledge reports within a few days.

## Supported versions

PyRoboVision v0.5+ receives security fixes. Patch releases are prioritized for vulnerabilities.
